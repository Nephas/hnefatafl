...
var vec__10196 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10196,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10196,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10196,(2),null);
var vec__10199 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10199,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10199,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10199,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__10202,p__10203){
var vec__10204 = p__10202;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10204,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10204,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10204,(2),null);
var vec__10207 = p__10203;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10207,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10207,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10207,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__10210_SHARP_){
return (p1__10210_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__10211_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__10212_SHARP_,angle_lr),angle_ud);
...
var map__10214 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10214__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10214__$1,cljs.core.cst$kw$straight);
var temp__5718__auto__ = (function (){var pred__10216 = cljs.core._EQ_;
var expr__10217 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__10219 = cljs.core.cst$kw$w;
...
if(cljs.core.truth_((function (){var G__10221 = cljs.core.cst$kw$s;
var G__10222 = expr__10217;
return (pred__10216.cljs$core$IFn$_invoke$arity$2 ? pred__10216.cljs$core$IFn$_invoke$arity$2(G__10221,G__10222) : pred__10216.call(null,G__10221,G__10222));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__10216.cljs$core$IFn$_invoke$arity$2 ? pred__10216.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__10217) : pred__10216.call(null,quil.middlewares.navigation_3d.space,expr__10217)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__10223 = cljs.core.cst$kw$z;
var G__10224 = expr__10217;
return (pred__10216.cljs$core$IFn$_invoke$arity$2 ? pred__10216.cljs$core$IFn$_invoke$arity$2(G__10223,G__10224) : pred__10216.call(null,G__10223,G__10224));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__10225 = cljs.core.cst$kw$d;
var G__10226 = expr__10217;
return (pred__10216.cljs$core$IFn$_invoke$arity$2 ? pred__10216.cljs$core$IFn$_invoke$arity$2(G__10225,G__10226) : pred__10216.call(null,G__10225,G__10226));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__10227 = cljs.core.cst$kw$a;
var G__10228 = expr__10217;
return (pred__10216.cljs$core$IFn$_invoke$arity$2 ? pred__10216.cljs$core$IFn$_invoke$arity$2(G__10227,G__10228) : pred__10216.call(null,G__10227,G__10228));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5718__auto__,map__10214,map__10214__$1,up,straight){
return (function (p1__10213_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__10213_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5718__auto__,map__10214,map__10214__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__10229_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__10230 = options;
var G__10231 = ((function (G__10230,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__10230,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__10230,G__10231) : rotate_on.call(null,G__10230,G__10231));
})();
...
var map__10232_10247 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__10232_10248__$1 = (((((!((map__10232_10247 == null))))?(((((map__10232_10247.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10232_10247.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10232_10247):map__10232_10247);
var vec__10233_10249 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10232_10248__$1,cljs.core.cst$kw$straight);
var c_x_10250 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10233_10249,(0),null);
var c_y_10251 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10233_10249,(1),null);
var c_z_10252 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10233_10249,(2),null);
var vec__10236_10253 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10232_10248__$1,cljs.core.cst$kw$up);
var u_x_10254 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10236_10253,(0),null);
var u_y_10255 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10236_10253,(1),null);
var u_z_10256 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10236_10253,(2),null);
var vec__10239_10257 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10232_10248__$1,cljs.core.cst$kw$position);
var p_x_10258 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10239_10257,(0),null);
var p_y_10259 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10239_10257,(1),null);
var p_z_10260 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10239_10257,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_10258,p_y_10259,p_z_10260,(p_x_10258 + c_x_10250),(p_y_10259 + c_y_10251),(p_z_10260 + c_z_10252),u_x_10254,u_y_10255,u_z_10256);
...
var G__10243 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__10244 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__10243,G__10244) : key_pressed.call(null,G__10243,G__10244));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__10245 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__10246 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__10245,G__10246) : rotate_on_fn.call(null,G__10245,G__10246));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
