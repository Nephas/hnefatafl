...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__10761_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_10762 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_10763 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_10762);
var pos_10764 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_10762);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_10763);

var tr__10668__auto___10765 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_10763) - cljs.core.first(pos_10764)),(((quil.core.height() / (2)) / zoom_10763) - cljs.core.second(pos_10764))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__10668__auto___10765);
...
var G__10766 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__10767 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__10766,G__10767) : user_mouse_dragged.call(null,G__10766,G__10767));
...
return (function (state,event){
var G__10768 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__10769 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__10768,G__10769) : user_mouse_wheel.call(null,G__10768,G__10769));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
